...
export const SUBWORKFLOW = {
  /** Default timeout for subworkflow completion */
  DEFAULT_TIMEOUT_MS: 300_000, // 5 minutes
  
  /** Default max polling attempts */
  DEFAULT_MAX_POLLS: 3000, // 5 min / 100ms
  
  /** Polling interval for subworkflow completion check */
...
export const COMPUTED = {
  ...
  RETRY_DELAY_SEQUENCE_MS: Array.from({ length: 5 }, (_, i) =>
    Math.min(TIMING.RETRY_BASE_DELAY_MS * Math.pow(TIMING.RETRY_MULTIPLIER, i), TIMING.MAX_RETRY_DELAY_MS)
  ),
} as const;
